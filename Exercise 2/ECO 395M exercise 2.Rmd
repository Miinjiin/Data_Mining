...
```{r problem 3.2, message=FALSE, echo=FALSE}
...
t_grid=rep(0.05:0.95)

roc = foreach(i=t_grid, .combine='rbind') %do% {
  yhat_val_best=ifelse(phat_val_best >= i, 1, 0)
