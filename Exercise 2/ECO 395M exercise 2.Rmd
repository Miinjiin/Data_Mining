...
Top one is rmse is for medium_rmse, below one is rmse for model we made.
Our model seems to do better at achieving lower out-ot-sample mean-squared error.
...
of the lowest estimators for Price given our KNN estimate is K=15. We will use
